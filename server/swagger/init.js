...
const doc = {
  info: {
    version: "1.0.0",
    title: "ParalegalAI Developer API",
    description:
      "API endpoints that enable programmatic reading, writing, and updating of your ParalegalAI instance. UI supplied by Swagger.io.",
  },
