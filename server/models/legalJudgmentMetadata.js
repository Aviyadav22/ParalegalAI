    ...
    try {
      const query = `
        INSERT INTO legal_judgment_metadata (
          doc_id, workspace_id, case_number, case_title, case_type,
          court_name, court_level, jurisdiction, bench_strength,
          petitioner, respondent, judges, author_judge,
          filing_date, judgment_date, decision_date,
          acts_cited, sections_cited, articles_cited, precedents_cited,
          decision_type, outcome, page_count, word_count,
          keywords, summary
        ) VALUES (
      ...
      const params = [
        ...
        data.court_level || null,
        data.jurisdiction || null,
        data.bench_strength || null,
        data.petitioner || null,
        data.respondent || null,
        data.judges || [],
        data.author_judge || null,
