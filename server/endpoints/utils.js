 ...
 * as well as build features in ParalegalAI directly for a specific model or capabilities.
 *
 * Disable with  {@link https://github.com/ParalegalAI-Team/paralegal-ai?tab=readme-ov-file#telemetry--privacy|Disable Telemetry}
...
/**
 * Returns the user agent for the ParalegalAI deployment.
 * @returns {string} The user agent.
 */
function getParalegalAIUserAgent() {
  const version = getDeploymentVersion() || "unknown";
  return `ParalegalAI/${version}`;
}
