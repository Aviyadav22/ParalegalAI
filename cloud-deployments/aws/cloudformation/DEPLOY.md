# How to deploy a private ParalegalAI instance on AWS
...
5. Use the file `cloudformation_create_paralegalai.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_paralegal-ai  Created 
 ⠿ Container paralegal-ai       Started  
```
