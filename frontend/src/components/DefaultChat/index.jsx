...
export default function DefaultChatContainer() {
        ...
        <MessageContent alignmentCls={getMessageAlignment("assistant")}>
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-5 w-fit transition-all duration-300 border border-black/50 px-4 py-2 rounded-lg text-theme-text-primary text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 focus:ring-gray-800"
            >
  ...
  return (
    <div
      ...
      className={`transition-all duration-500 relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] bg-theme-bg-secondary border-[1px] border-theme-sidebar-border w-full h-full overflow-y-scroll ${
...
function MessageText({ children }) {
  return (
    <span className="text-theme-text-primary font-light text-[14px] flex flex-col gap-y-1 mt-2">
      {children}
    </span>
  );
}
