...
export default function DefaultChatContainer() {
  ...
  const popMsg = !window.localStorage.getItem("paralegalai_intro");
  ...
  useEffect(() => {
    function processMsgs() {
      if (!!window.localStorage.getItem("paralegalai_intro")) {
      ...
      window.localStorage.setItem("paralegalai_intro", 1);
    }
