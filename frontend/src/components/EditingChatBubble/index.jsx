...
export default function EditingChatBubble({
  ...
  return (
    <div>
      <p
        className={`text-xs text-white text-black/80 ${isUser ? "text-right" : ""}`}
      >
        {isUser
          ? t("common.user")
      ...
      >
        <button
          className={`transition-all duration-300 absolute z-10 text-white rounded-full hover:bg-neutral-700 hover:invert hover:border-white border-transparent border shadow-lg ${
        ...
        >
          {isEditing ? (
            ...
            tempMessage && (
              <div
                className="markdown font-[500] md:font-semibold text-sm md:text-base break-words invert"
