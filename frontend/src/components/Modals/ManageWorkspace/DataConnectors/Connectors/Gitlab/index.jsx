        ...
        <form className="w-full" onSubmit={handleSubmit}>
          <div className="w-full flex flex-col py-2">
            ...
            <div className="flex flex-col w-full py-4 pr-10">
              ...
              <TagsInput
                ...
                classNames={{
                  tag: "bg-theme-settings-input-bg bg-black/10 bg-blue-300/10 text-zinc-800",
                  input:
          ...
          <div className="flex flex-col gap-y-2 w-full pr-10">
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 w-full justify-center border-none px-4 py-2 rounded-lg text-white text-sm font-bold items-center flex gap-x-2 bg-theme-home-button-primary hover:bg-theme-home-button-primary-hover disabled:bg-theme-home-button-primary-hover disabled:cursor-not-allowed"
            >
