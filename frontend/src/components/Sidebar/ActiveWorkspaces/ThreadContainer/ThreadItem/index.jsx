  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`${
          isActive
            ? "border-l-2 border-b-2 border-white border-theme-sidebar-border z-[2]"
            : "border-l border-b border-[#6F6F71] border-theme-sidebar-border z-[1]"
        ...
        <div
          ...
          className={`${
            idx <= activeIdx && !isActive
              ? "border-l-2 border-white border-theme-sidebar-border z-[2]"
              : "border-l border-[#6F6F71] border-theme-sidebar-border z-[1]"
      ...
      />
      <div
        className={`flex w-full items-center justify-between pr-2 group relative ${isActive ? "bg-[var(--theme-sidebar-thread-selected)] border border-solid border-transparent border-blue-400" : "hover:bg-theme-sidebar-subitem-hover"} rounded-[4px]`}
      >
        {thread.deleted ? (
          <div className="w-full flex justify-between">
            <div className="w-full pl-2 py-1">
              <p
                className={`text-left text-sm text-slate-400/50 text-slate-500 italic`}
              >
                deleted thread
              </p>
            </div>
            {ctrlPressed && (
              ...
              >
                <ArrowCounterClockwise
                  className="text-zinc-300 hover:text-white text-theme-text-secondary hover:text-theme-text-primary"
                  size={18}
                />
              </button>
            )}
        ...
        {!!thread.slug && !thread.deleted && (
          <div ref={optionsContainer} className="flex items-center">
            ...
            {ctrlPressed ? (
              ...
              >
                <X
                  className="text-zinc-300 text-theme-text-secondary hover:text-white hover:text-theme-text-primary"
                  weight="bold"
                  size={18}
                />
              </button>
              ...
              <div className="flex items-center w-fit group-hover:visible md:invisible gap-x-1">
                ...
                >
                  <DotsThree
                    className="text-slate-300 text-theme-text-secondary hover:text-white hover:text-theme-text-primary"
                    size={25}
                  />
                </button>
              </div>
...
function OptionsMenu({
  ...
  return (
    <div
      ref={menuRef}
      className="absolute w-fit z-[20] top-[25px] right-[10px] context-menu p-1"
    >
      <button
      ...
      <button
        ...
        type="button"
        className="w-full rounded-md flex items-center p-2 gap-x-2 hover:bg-red-500/20 hover:text-red-600"
      >
        <Trash size={18} />
