...
export default function SettingsSidebar() {
  ...
  if (isMobile) {
    return (
      <>
        <div className="fixed top-0 left-0 right-0 z-10 flex justify-between items-center px-4 py-2 bg-theme-bg-sidebar bg-white text-theme-text-secondary shadow-lg h-16">
          <button
  ...
  return (
    <>
      <div>
        ...
        <div
          ref={sidebarRef}
          className="transition-all duration-500 relative m-[16px] rounded-[16px] bg-theme-bg-sidebar border-[2px] border-theme-sidebar-border border-none min-w-[250px] p-[10px] h-[calc(100%-76px)]"
        >
              ...
              <div className="h-auto sidebar-items">
                <div className="flex flex-col gap-y-2 pb-[60px] overflow-y-scroll no-scroll">
                  ...
                  <Link
                    ...
                    to={paths.settings.privacy()}
                    className="text-theme-text-secondary hover:text-white hover:text-theme-text-primary text-xs leading-[18px] mx-3"
                  >
                    {t("settings.privacy")}
                  </Link>
                  <AppVersion />
...
function SupportEmail() {
  ...
  return (
    <Link
      to={supportEmail}
      className="text-theme-text-secondary hover:text-white hover:text-theme-text-primary text-xs leading-[18px] mx-3 mt-1"
    >
      {t("settings.contact")}
    </Link>
  );
...
function AppVersion() {
  ...
  return (
    <Link
      ...
      target="_blank"
      rel="noreferrer"
      className="text-theme-text-secondary opacity-80 opacity-50 text-xs mx-3"
    >
      v{version}
    </Link>
  );
