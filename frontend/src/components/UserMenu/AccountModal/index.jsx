          ...
          <form onSubmit={handleUpdate} className="space-y-6">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <div className="flex flex-col items-center">
                <label className="group w-48 h-48 flex flex-col items-center justify-center bg-[#E0F2FE] hover:bg-transparent transition-colors duration-300 rounded-full mt-8 border-2 border-dashed border-[#686C6F] cursor-pointer hover:opacity-60">
                  <input
                    id="logo-upload"
                    type="file"
                    accept="image/*"
...
// Theme preference component removed - only light mode is available
