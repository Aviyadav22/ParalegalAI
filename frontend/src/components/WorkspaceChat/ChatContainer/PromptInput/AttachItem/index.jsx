  ...
  return (
    <>
      <button
        ...
        className={`border-none relative flex justify-center items-center opacity-60 hover:opacity-100 opacity-100 hover:opacity-60 cursor-pointer`}
      >
        <div className="relative">
          ...
          />
          {files.length > 0 && (
            <div className="absolute -top-2 right-[1%] bg-white text-black invert text-[8px] rounded-full px-1 flex items-center justify-center">
              {files.length}
            </div>
          )}
        </div>
      ...
      {showTooltip && (
        <Tooltip
          ...
          className="z-99 !w-[400px] !bg-theme-bg-primary !px-[5px] !rounded-lg !pointer-events-auto border-2 border-theme-modal-border"
        >
          <ParsedFilesMenu
