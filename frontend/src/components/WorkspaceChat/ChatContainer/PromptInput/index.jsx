    ...
    <div className="w-full fixed md:absolute bottom-0 left-0 z-10 md:z-0 flex justify-center items-center">
      ...
      >
        <div className="flex items-center rounded-lg md:mb-4 md:w-full">
          <div className="w-[95vw] md:w-[635px] bg-theme-bg-chat-input bg-white border-solid border-[1px] border-theme-chat-input-border shadow-sm rounded-2xl flex flex-col px-2 overflow-hidden">
            ...
            <div className="flex items-center border-b border-theme-chat-input-border mx-3">
              <textarea
                ...
                className={`border-none cursor-text max-h-[50vh] md:max-h-[350px] md:min-h-[40px] mx-2 md:mx-0 pt-[12px] w-full leading-5 md:text-md text-white bg-transparent placeholder:text-white/60 placeholder:text-theme-text-primary resize-none active:outline-none focus:outline-none flex-grow mb-1 ${textSizeClass}`}
              ...
              {isStreaming ? (
                ...
                <>
                  <button
                    ...
                    type="submit"
                    disabled={isDisabled}
                    className="border-none inline-flex justify-center rounded-2xl cursor-pointer opacity-60 hover:opacity-100 opacity-100 hover:opacity-60 ml-4 disabled:cursor-not-allowed group"
