  ...
  return (
    <div className="w-full fixed md:absolute bottom-0 left-0 z-10 md:z-0 flex justify-center items-center">
      ...
      <form
        ...
        className="flex flex-col gap-y-1 rounded-t-lg md:w-3/4 w-full mx-auto max-w-xl items-center px-2 sm:px-0"
      >
        <div className="flex items-center rounded-lg md:mb-4 md:w-full">
          <div className="w-full max-w-[95vw] sm:w-[95vw] md:w-[635px] bg-theme-bg-chat-input light:bg-white light:border-solid light:border-[1px] light:border-theme-chat-input-border shadow-sm rounded-2xl flex flex-col px-2 overflow-hidden">
            ...
            <div className="flex justify-between py-2 sm:py-3.5 mx-2 sm:mx-3 mb-1">
