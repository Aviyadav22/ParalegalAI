          ...
          <div className="w-[95vw] md:w-[635px] bg-theme-bg-chat-input bg-white border-solid border-[1px] border-theme-chat-input-border shadow-sm rounded-2xl flex flex-col px-2 overflow-hidden">
            ...
            <div className="flex items-center border-b border-theme-chat-input-border mx-3">
              <textarea
                ...
                className={`border-none cursor-text max-h-[50vh] md:max-h-[350px] md:min-h-[40px] mx-2 md:mx-0 pt-[12px] w-full leading-5 md:text-md text-theme-text-primary bg-transparent placeholder:text-theme-text-primary/60 resize-none active:outline-none focus:outline-none flex-grow mb-1 ${textSizeClass}`}
