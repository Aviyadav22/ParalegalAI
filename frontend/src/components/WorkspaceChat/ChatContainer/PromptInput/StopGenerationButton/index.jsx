    ...
    <>
      ...
      >
        <svg
          ...
          className="opacity-60 group-hover:opacity-100 opacity-100 group-hover:opacity-60"
        >
          <circle
            cx="10"
            cy="10.562"
            r="9"
            strokeWidth="2"
            className="group-hover:stroke-primary-button stroke-white stroke-theme-text-secondary"
          />
          <rect
            x="6.3999"
            y="6.96204"
            ...
            height="7.2"
            rx="2"
            className="group-hover:fill-primary-button fill-white fill-theme-text-secondary"
          />
        </svg>
      </button>
      <Tooltip
