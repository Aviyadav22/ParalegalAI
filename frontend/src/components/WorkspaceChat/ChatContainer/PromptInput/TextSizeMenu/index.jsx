  ...
  return (
    <>
      <div
        ...
        className="border-none flex justify-center items-center opacity-60 hover:opacity-100 opacity-100 hover:opacity-60 cursor-pointer"
      >
        <TextT
      ...
      <Tooltip
        ...
        className="z-99 !w-[140px] !bg-theme-bg-primary !px-[5px] !rounded-lg !pointer-events-auto border-2 border-theme-modal-border"
      >
