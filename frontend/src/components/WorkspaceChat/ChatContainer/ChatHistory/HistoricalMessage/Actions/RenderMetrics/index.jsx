...
const SHOW_METRICS_KEY = "paralegalai_show_chat_metrics";
const SHOW_METRICS_EVENT = "paralegalai_show_metrics_change";
...
/**
 * Get the show metrics setting from localStorage `paralegalai_show_chat_metrics` key
 * @returns {boolean}
 */
...
/**
 * Toggle the show metrics setting in localStorage `paralegalai_show_chat_metrics` key
 * @returns {void}
 */
