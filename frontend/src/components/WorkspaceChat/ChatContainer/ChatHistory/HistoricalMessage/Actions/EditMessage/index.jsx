  ...
  return (
    <form onSubmit={handleSaveMessage} className="flex flex-col w-full">
      ...
      <div className="mt-3 flex justify-center">
        ...
        <button
          type="button"
          className="border-none px-2 py-1 bg-historical-msg-system text-white font-medium rounded-md hover:bg-historical-msg-user/90 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
          onClick={cancelEdits}
        >
