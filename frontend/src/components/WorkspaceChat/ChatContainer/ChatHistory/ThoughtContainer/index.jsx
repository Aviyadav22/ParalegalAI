              ...
              {isThinking || isComplete ? (
                <>
                  <video
                    ...
                    muted
                    playsInline
                    className={`w-7 h-7 transition-opacity duration-200 invert opacity-50 ${isThinking ? "opacity-100" : "opacity-0 hidden"}`}
                  ...
                  <img
                    ...
                    className={`w-6 h-6 transition-opacity duration-200 invert opacity-50 ${!isThinking && isComplete ? "opacity-100" : "opacity-0 hidden"}`}
                    data-tooltip-id="cot-thinking"
