  ...
  return (
    <div className="flex flex-col mt-4 justify-left">
      <button
        ...
        className={`border-none font-semibold text-white/50 text-black/50 font-medium italic ${textSizeClass} text-left ml-14 pt-2 ${
          open ? "pb-2" : ""
        } hover:text-white/75 hover:text-black/75 transition-all duration-300`}
      >
        {open
