...
const System = {
  cacheKeys: {
    footerIcons: "paralegalai_footer_links",
    supportEmail: "paralegalai_support_email",
    customAppName: "paralegalai_custom_app_name",
    canViewChatHistory: "paralegalai_can_view_chat_history",
    deploymentVersion: "paralegalai_deployment_version",
  },
  // ==== SaaS Auth & Subscription Helpers ====
  ...
  subscription: {
    plans: async function () {
      return await fetch(`${API_BASE}/subscription/plans`, {
        method: "GET",
        headers: baseHeaders(),
      })
        .then((res) => res.json())
    ...
    current: async function () {
      return await fetch(`${API_BASE}/subscription/current`, {
        method: "GET",
        headers: baseHeaders(),
      })
        .then((res) => res.json())
    ...
    usage: async function () {
      return await fetch(`${API_BASE}/subscription/usage`, {
        method: "GET",
        headers: baseHeaders(),
      })
        .then((res) => res.json())
    ...
    update: async function (tier) {
      return await fetch(`${API_BASE}/subscription/update`, {
        method: "POST",
        headers: baseHeaders(),
