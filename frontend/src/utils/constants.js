...
export const ONBOARDING_SURVEY_URL = "https://onboarding.paralegalai.com";

export const AUTH_USER = "paralegalai_user";
export const AUTH_TOKEN = "paralegalai_authToken";
export const AUTH_TIMESTAMP = "paralegalai_authTimestamp";
export const COMPLETE_QUESTIONNAIRE = "paralegalai_completed_questionnaire";
export const SEEN_DOC_PIN_ALERT = "paralegalai_pinned_document_alert";
export const SEEN_WATCH_ALERT = "paralegalai_watched_document_alert";

export const APPEARANCE_SETTINGS = "paralegalai_appearance_settings";
