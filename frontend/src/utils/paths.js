...
export default {
  ...
  github: () => {
    return "https://github.com/ParalegalAI-Team/paralegal-ai";
  },
  discord: () => {
    return "https://discord.com/invite/6UyHPeGZAC";
  },
  docs: () => {
    return "https://docs.paralegalai.com";
  },
  chatModes: () => {
    return "https://docs.paralegalai.com/features/chat-modes";
  },
  mailToMintplex: () => {
    return "mailto:team@mintplexlabs.com";
  },
  hosting: () => {
    return "https://my.mintplexlabs.com/aio-checkout?product=paralegalai";
  },
  workspace: {
    chat: (slug, options = {}) => {
  ...
  communityHub: {
    ...
    noPrivateItems: () => {
      return "https://docs.paralegalai.com/community-hub/faq#no-private-items";
    },
  },

  // TODO: Migrate all docs.paralegalai.com links to the new docs.
  documentation: {
    mobileIntroduction: () => {
      return "https://docs.paralegalai.com/mobile/overview";
    },
    contextWindows: () => {
      return "https://docs.paralegalai.com/chatting-with-documents/introduction#you-exceed-the-context-window---what-now";
    },
  },
