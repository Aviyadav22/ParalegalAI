...
const markdown = markdownIt({
  ...
  highlight: function (code, lang) {
    ...
    if (lang && hljs.getLanguage(lang)) {
      try {
        return (
          `<div class="whitespace-pre-line w-full max-w-[65vw] hljs ${theme} border-solid border border-gray-700 rounded-lg relative font-mono font-normal text-sm text-slate-200">
            <div class="w-full flex items-center sticky top-0 text-slate-200 bg-sky-800 px-4 py-2 text-xs font-sans justify-between rounded-t-md -mt-5">
