        ...
        <div
          ...
          className={`py-3 px-4 flex items-center justify-between ${
            ...
            selectedFeature === feature
              ? "bg-white/10 bg-theme-bg-sidebar  "
              : ""
          }`}
          onClick={() => {
          ...
          <div className="w-full max-w-2xl bg-theme-bg-secondary rounded-lg shadow border-2 border-theme-modal-border overflow-hidden">
            ...
            <form onSubmit={acceptTos}>
              ...
              <div className="flex w-full justify-between items-center p-6 space-x-2 border-t border-theme-modal-border rounded-b">
                <a
                  href={paths.home()}
                  className="transition-all duration-300 bg-transparent text-white hover:bg-red-500/50 hover:bg-red-300/50 px-4 py-2 rounded-lg text-sm border border-theme-modal-border"
                >
                  Reject & close
                </a>
                <button
