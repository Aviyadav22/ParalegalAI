      ...
      >
        ...
        <td className="px-6 flex items-center gap-x-6 h-full mt-2">
          {canModify && (
            <button
              onClick={openModal}
              className="text-xs font-medium text-white/80 text-black/80 rounded-lg hover:text-white hover:text-gray-500 px-2 py-1 hover:bg-white hover:bg-opacity-10"
            >
              Edit
            </button>
          )}
          {currUser?.id !== user.id && canModify && (
            <>
              <button
                ...
                className="text-xs font-medium text-white/80 text-black/80 hover:text-orange-500 hover:text-orange-300 rounded-lg px-2 py-1 hover:bg-white hover:bg-orange-50 hover:bg-opacity-10"
              >
                {suspended ? "Unsuspend" : "Suspend"}
              </button>
              <button
                onClick={handleDelete}
                className="text-xs font-medium text-white/80 text-black/80 hover:text-red-500 hover:text-red-300 rounded-lg px-2 py-1 hover:bg-white hover:bg-red-50 hover:bg-opacity-10"
              >
                Delete
              </button>
            </>
