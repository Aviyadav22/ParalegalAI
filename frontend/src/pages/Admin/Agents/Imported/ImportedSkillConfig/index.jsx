            ...
            <div className="flex flex-col gap-y-2">
              {Object.entries(config.setup_args).map(([key, props]) => (
                <div key={key} className="flex flex-col gap-y-1">
                  ...
                  <input
                    ...
                    className="border-solid bg-transparent border border-white border-black rounded-md p-2 text-white text-sm"
                  />
                  <p className="text-white text-opacity-60 text-xs font-medium py-1.5">
                    {props?.input?.hint}
                  </p>
              ...
              {hasChanges && (
                <button
                  ...
                  type="button"
                  className="bg-blue-500 text-white text-white rounded-md p-2"
                >
                  Save
                </button>
              )}
