        ...
        <div>
          ...
          <div className="space-y-2">
            <select
              ...
              className="w-full p-2.5 text-sm rounded-lg bg-theme-bg-primary border border-white/5 text-theme-text-primary focus:border-primary-button focus:ring-1 focus:ring-primary-button outline-none bg-theme-settings-input-bg border-black/10"
            >
              <option
                value="json"
                className="bg-theme-bg-primary bg-theme-settings-input-bg"
              >
                JSON
              </option>
              <option
            ...
            {config.bodyType === "json" ? (
              <textarea
                ...
                className="w-full p-2.5 text-sm rounded-lg bg-theme-bg-primary border border-white/5 text-theme-text-primary placeholder:text-theme-text-secondary/20 focus:border-primary-button focus:ring-1 focus:ring-primary-button outline-none bg-theme-settings-input-bg border-black/10 font-mono"
                rows={4}
                autoComplete="off"
                spellCheck={false}
              />
                ...
                {(config.formData || []).map((item, index) => (
                  <div key={index} className="flex gap-2">
                    <input
                      ...
                      className="flex-1 p-2.5 text-sm rounded-lg bg-theme-bg-primary border border-white/5 text-theme-text-primary placeholder:text-theme-text-secondary/20 focus:border-primary-button focus:ring-1 focus:ring-primary-button outline-none bg-theme-settings-input-bg border-black/10"
                      autoComplete="off"
                      spellCheck={false}
                    />
                    <input
                    ...
                    <button
                      ...
                      className="p-2.5 rounded-lg bg-theme-bg-primary border border-white/5 text-theme-text-primary hover:text-red-500 hover:border-red-500/20 hover:bg-red-500/10 transition-colors duration-300 bg-theme-settings-input-bg border-black/10"
                      title="Remove field"
                    >
                      <X className="w-4 h-4" />
                    </button>
