      ...
      <div>
        ...
        <div className="relative w-full flex flex-col items-end">
          <button
            ...
            type="button"
            className="text-theme-text-secondary hover:text-black text-xs font-medium"
            onClick={(e) => {
              e.preventDefault();
            ...
            {prompt !== DEFAULT_PROMPT && (
              <>
                <button
                  ...
                  className="text-theme-text-primary hover:text-black text-xs font-medium"
                >
                  Clear
                </button>
                <PublishPromptCTA
...
function PublishPromptCTA({ hidden = false, onClick }) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="border-none text-primary-button hover:text-black text-xs font-medium"
    >
