  ...
  return (
    ...
    >
      ...
      {isCompleted ? (
        ...
        <button className="w-[64px] h-[24px] rounded-md bg-white/70 text-theme-checklist-item-text font-semibold text-xs transition-all duration-200 flex items-center justify-center hover:bg-white/60">
          {action}
        </button>
      )}
    </div>
