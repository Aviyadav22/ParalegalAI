...
export const CHECKLIST_UPDATED_EVENT = "paralegalai_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "paralegalai_checklist_completed";
export const CHECKLIST_HIDDEN = "paralegalai_checklist_dismissed";
