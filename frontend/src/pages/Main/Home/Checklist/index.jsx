  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{}}
          className="bg-[rgba(216,243,234,0.5)] w-full h-full flex items-center justify-center bg-theme-checklist-item-completed-bg/50 rounded-lg"
        >
      ...
      >
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-x-2">
            <button
              onClick={handleClose}
              className="text-theme-home-text-secondary bg-theme-home-bg-button px-3 py-1 rounded-xl hover:bg-white/10 transition-colors text-xs"
            >
