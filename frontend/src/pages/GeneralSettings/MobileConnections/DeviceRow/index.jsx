      ...
      <tr className="bg-transparent text-white text-opacity-80 text-xs font-medium border-b border-white/10 h-10">
        ...
        <td className="px-6 flex items-center gap-x-6 h-full mt-1">
          {status ? (
            <button
              onClick={handleDeny}
              className={`border-none flex items-center justify-center text-xs font-medium text-white/80 text-black/80 rounded-lg p-1 hover:bg-white hover:bg-red-50 hover:bg-opacity-10`}
            >
              Revoke
            </button>
          ) : (
            <>
              <button
                ...
                className={`border-none flex items-center justify-center text-xs font-medium text-white/80 text-black/80 rounded-lg p-1 hover:bg-white hover:bg-opacity-10 hover:bg-green-50 hover:text-green-500 hover:text-green-300`}
              >
                Approve Access
              </button>
              <button
                onClick={handleDeny}
                className={`border-none flex items-center justify-center text-xs font-medium text-white/80 text-black/80 rounded-lg p-1 hover:bg-white hover:bg-opacity-10 hover:bg-red-50 hover:text-red-500 hover:text-red-300`}
              >
                Deny
              </button>
            </>
