    ...
    <div className="w-screen h-screen overflow-hidden bg-theme-bg-container flex">
      ...
      >
        <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:pt-6">
          <p className="text-lg leading-6 font-bold text-theme-text-primary md-6 border-white border-theme-sidebar-border border-b-2 border-opacity-10 py-4">
            {t("security.title")}
          </p>
        </div>
        <MultiUserMode />
...
function MultiUserMode() {
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col gap-y-1 w-full flex flex-col gap-y-1 pb-6 border-white border-theme-sidebar-border border-b-2 border-opacity-10">
...
function PasswordProtection() {
  ...
  return (
    <form
      ...
      className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px]"
    >
      <div className="w-full flex flex-col gap-y-1 pb-6 border-white border-theme-sidebar-border border-b-2 border-opacity-10">
        <div className="w-full flex flex-col gap-y-1">
          <div className="items-center flex gap-x-4">
            <p className="text-base font-bold text-white mt-6">
        ...
        <div className="relative w-full max-h-full">
          <div className="relative rounded-lg">
            ...
            <div className="flex items-center justify-between space-x-14">
              <p className="text-white text-opacity-80 text-theme-text text-xs rounded-lg w-96">
                {t("security.password.description")}
              </p>
            </div>
          </div>
