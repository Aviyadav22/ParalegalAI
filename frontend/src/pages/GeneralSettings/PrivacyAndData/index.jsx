  ...
  return (
    <div className="w-screen h-screen overflow-hidden bg-theme-bg-container flex">
      ...
      <div
        ...
        className="relative md:ml-[2px] md:mr-[16px] md:my-[16px] md:rounded-[16px] border border-theme-sidebar-border bg-theme-bg-secondary w-full h-full overflow-y-scroll p-4 md:p-0"
      >
