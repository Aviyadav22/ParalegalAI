      ...
      <div className="relative rounded-lg">
        ...
        <div className="flex flex-col items-left space-y-2">
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            look on{" "}
            <a
              href="https://github.com/search?q=repo%3AParalegalAI-Team%2Fparalegal-ai%20.sendTelemetry(&type=code"
          ...
          <p className="text-theme-text-secondary text-xs rounded-lg w-96">
            ...
            so that we can continue to improve ParalegalAI for you.{" "}
            <a
