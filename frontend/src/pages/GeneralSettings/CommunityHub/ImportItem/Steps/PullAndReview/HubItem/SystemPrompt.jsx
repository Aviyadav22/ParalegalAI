    ...
    <div className="flex flex-col mt-4 gap-y-4">
      ...
      <div className="flex flex-col gap-y-[25px] text-white/80 text-theme-text-secondary text-sm">
        ...
        <div className="flex flex-col gap-y-2">
          <p className="text-white/60 text-theme-text-secondary font-semibold">
          ...
          <div className="w-full text-theme-text-primary text-md flex flex-col max-h-[calc(300px)] overflow-y-auto">
            <p className="text-white/60 text-theme-text-secondary font-mono bg-zinc-900 bg-slate-200 px-2 py-1 rounded-md text-sm whitespace-pre-line">
              {item.prompt}
            </p>
          </div>
        </div>
