...
export default function AgentSkill({ item, settings, setStep }) {
  ...
  return (
    <div className="flex flex-col mt-4 gap-y-4">
      <div className="border border-white/10 border-orange-500/20 my-2 flex flex-col md:flex-row md:items-center gap-x-2 text-theme-text-primary text-orange-600 mb-4 bg-orange-800/30 bg-orange-500/10 rounded-lg px-4 py-2">
      ...
      <div className="flex flex-col gap-y-1">
        ...
        {item.creatorUsername && (
          <p className="text-white/60 text-theme-text-secondary text-xs font-mono">
            Created by{" "}
            <a
      ...
      <div className="flex flex-col gap-y-[25px] text-white/80 text-theme-text-secondary text-sm">
        <p>
          Agent skills unlock new capabilities for your AnythingLLM workspace
          via{" "}
          <code className="font-mono bg-zinc-900 bg-slate-200 px-1 py-0.5 rounded-md text-sm">
            @agent
          </code>{" "}
    ...
    <div className="flex flex-col gap-y-2">
      <div className="flex flex-col gap-y-2">
        <div className="flex justify-between items-center">
          <button
            type="button"
            className={`border-none bg-black/70 bg-slate-200 rounded-md p-1 text-white/60 text-theme-text-secondary text-xs font-mono ${
