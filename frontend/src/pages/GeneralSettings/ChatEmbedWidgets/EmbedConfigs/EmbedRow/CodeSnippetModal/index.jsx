...
// Dark theme CSS removed - only light mode available
...
<!-- Paralegal AI (https://paralegal-ai.com) -->
`;
}
  ...
  return (
    <div>
      ...
      <button
        disabled={copied}
        onClick={handleClick}
        className={`disabled:border disabled:border-green-600 border border-transparent relative w-full font-mono flex hljs ${theme} border border-gray-700 text-white placeholder:text-theme-settings-input-placeholder text-sm rounded-lg focus:outline-primary-button active:outline-primary-button outline-none p-2.5 m-1`}
      >
        <div
