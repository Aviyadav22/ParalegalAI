...
https://github.com/ParalegalAI-Team/paralegalai-embed/blob/main/README.md
-->
<script
  data-embed-id="${embed.uuid}"
  data-base-api-url="${serverHost}/api/embed"
  src="${scriptHost}/embed/paralegalai-chat-widget.min.js">
</script>
<!-- ParalegalAI (https://paralegalai.com) -->
`;
}
  ...
  return (
    <div>
      <div className="flex flex-col mb-2">
        ...
        <a
          href="https://github.com/ParalegalAI-Team/paralegalai-embed/blob/main/README.md"
          target="_blank"
          rel="noreferrer"
