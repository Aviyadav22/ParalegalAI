              ...
              <div className="flex flex-wrap gap-4 items-center">
                ...
                <div className="relative">
                  <button
                    ref={openMenuButton}
                    onClick={toggleMenu}
                    className="flex items-center gap-x-2 px-4 py-1 rounded-lg bg-primary-button hover:bg-theme-bg-primary hover:text-theme-text-primary text-xs font-semibold hover:bg-secondary shadow-[0_4px_14px_rgba(0,0,0,0.25)] h-[34px] w-fit"
                  >
                  ...
                  <div
                    ...
                    } z-20 w-fit rounded-lg absolute top-full right-0 bg-secondary bg-theme-bg-secondary mt-2 shadow-md`}
                  >
                    <div className="py-2">
                      {Object.entries(exportOptions).map(([key, data]) => (
                        <button
                          ...
                          className="w-full text-left px-4 py-2 text-white text-sm hover:bg-[#3D4147] hover:bg-theme-sidebar-item-hover"
                        >
                          {data.name}
                        </button>
                      ))}
  ...
  return (
    <>
      ...
      <div className="flex w-full justify-between items-center mt-6">
        ...
        <button
          onClick={handleNext}
          className="px-4 py-2 rounded-lg border border-slate-200 text-slate-200 text-theme-text-secondary border-theme-sidebar-border text-sm items-center flex gap-x-2 hover:bg-slate-200 hover:text-slate-800 disabled:invisible"
          disabled={!canNext}
        >
          Next Page
        </button>
