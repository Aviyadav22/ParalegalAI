...
export default function UserSetup({ setHeader, setForwardBtn, setBackBtn }) {
  ...
  return (
    <div className="w-full flex items-center justify-center flex-col gap-y-6">
      <div className="flex flex-col border rounded-lg border-theme-sidebar-border p-8 items-center gap-y-4 w-full max-w-[600px]">
...
const MyTeam = ({ setMultiUserLoginValid, myTeamSubmitRef, navigate }) => {
  ...
  return (
    <div className="w-full flex items-center justify-center border max-w-[600px] rounded-lg border-theme-sidebar-border">
