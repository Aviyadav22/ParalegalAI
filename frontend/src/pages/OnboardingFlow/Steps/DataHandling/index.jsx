...
import ParalegalAIIcon from "@/media/logo/paralegal-ai-icon.png";
...
export const VECTOR_DB_PRIVACY = {
  ...
  lancedb: {
    name: "LanceDB",
    description: [
      "Your vectors and document text are stored privately on this instance of ParalegalAI",
    ],
    logo: LanceDbLogo,
  },
};
...
export const EMBEDDING_ENGINE_PRIVACY = {
  native: {
    name: "ParalegalAI Embedder",
    description: [
      "Your document text is embedded privately on this instance of ParalegalAI",
    ],
    logo: ParalegalAIIcon,
  },
  openai: {
    name: "OpenAI",
    description: [
...
export const FALLBACKS = {
  LLM: (provider) => ({
    name: "Unknown",
    description: [
      `"${provider}" has no known data handling policy defined in ParalegalAI`,
    ],
    logo: ParalegalAIIcon,
  }),
  EMBEDDING: (provider) => ({
