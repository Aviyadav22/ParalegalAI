...
import ParalegalAILogo from "@/media/logo/paralegal-ai.png";
import { useNavigate } from "react-router-dom";
import { useTheme } from "@/hooks/useTheme";
import { useTranslation } from "react-i18next";

// Light theme only - simplified image selection
const srcSet = {
  l: LGroupImgLight,
  r: RGroupImgLight,
};
        ...
        <div className="relative flex justify-center items-center m-auto">
          <div className="flex flex-col justify-center items-center">
            ...
            <img
              src={ParalegalAILogo}
              alt="Paralegal AI"
              className="md:h-[50px] flex-shrink-0 max-w-[300px] invert"
            />
            <button
              onClick={() => navigate(paths.onboarding.llmPreference())}
              className="border-[2px] border-theme-text-primary w-full md:max-w-[350px] md:min-w-[300px] text-center py-3 bg-theme-button-primary hover:bg-theme-bg-secondary text-theme-text-primary font-semibold text-sm my-10 rounded-md "
            >
