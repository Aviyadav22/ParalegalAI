...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "ParalegalAI töötab paljude LLM-teenusepakkujatega. See teenus haldab vestlust.",
    },
    userSetup: {
    ...
    survey: {
      title: "Tere tulemast ParalegalAI-i",
      description:
        "Aita meil ParalegalAI sinu vajadustele vastavaks kujundada. Valikuline.",
      email: "Mis on su e-post?",
      useCase: "Milleks kasutad ParalegalAI-i?",
      useCaseWork: "Töö jaoks",
      useCasePersonal: "Isiklikuks kasutuseks",
      useCaseOther: "Muu",
      comment: "Kust kuulsid ParalegalAI-ist?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Loo esimene tööruum ja alusta ParalegalAI-iga.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Tere tulemast ParalegalAI-i! See on ParalegalAI Teami avatud lähtekoodiga AI-tööriist, mis muudab kõik failid koolitatud juturobotiks, kellega saad vestelda. ParalegalAI on BYOK-tarkvara, seega puudub igasugune tellimus- või litsentsitasu, välja arvatud kasutatavate teenuste kulud.",
    part2:
      "ParalegalAI on lihtsaim viis kombineerida võimsad AI-teenused nagu OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB jpt ilma vaevata, tõstes sinu produktiivsust kordades.",
    part3:
      "ParalegalAI võib töötada täielikult lokaalselt sinu masinas minimaalse ressursikasutusega – GPU-d pole vaja. Samuti on saadaval pilve- ja kohapealsed paigaldised.\nAI-ökosüsteem muutub iga päevaga võimekamaks ja ParalegalAI teeb selle kasutamise lihtsaks.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Oled teel ParalegalAI-i eksperdiks saama!",
      dismiss: "sulge",
      tasks: {
        create_workspace: {
          title: "Loo tööruum",
  ...
  customization: {
    interface: {
      ...
      description: "Sea ParalegalAI-i UI eelistused.",
    },
    branding: {
      title: "Bränding ja valgesildistamine",
      description: "Valgesildista oma ParalegalAI kohandatud brändinguga.",
    },
    chat: {
      title: "Vestlus",
    ...
    items: {
      ...
      "display-language": {
        title: "Kuvakeel",
        description:
          "Vali keel, milles ParalegalAI UI kuvatakse (kui tõlge on olemas).",
      },
      logo: {
        title: "Brändi logo",
      ...
      "welcome-messages": {
        ...
        user: "kasutaja",
        message: "sõnum",
        assistant: "ParalegalAI vestlusabi",
  ...
  api: {
    title: "API võtmed",
    description:
      "API võtmed võimaldavad programmipõhiselt hallata seda ParalegalAI instantsi.",
  ...
  llm: {
    title: "LLM-i eelistus",
    description:
      "Siin on sinu valitud LLM-teenusepakkuja võtmed ja seaded. Need peavad olema õiged, vastasel juhul ParalegalAI ei tööta.",
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding muudab teksti vektoriteks. Need võtmed on vajalikud, et ParalegalAI saaks sinu failid ja päringud töödelda.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Siin on seaded, kuidas ParalegalAI töötab. Vale seadistus võib põhjustada tõrkeid.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Konfiguratsioon kolmandate osapoolte ja ParalegalAI-i andmekäitluse kohta.",
    llm: "LLM-i valik",
