const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "ParalegalAI can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to ParalegalAI",
      description: "Help us make ParalegalAI built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you use ParalegalAI for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about ParalegalAI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with ParalegalAI.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Welcome to ParalegalAI, your intelligent legal research and drafting assistant. ParalegalAI helps you find relevant judgments, draft legal documents, and analyze case law with the power of AI.",
    part2:
      "ParalegalAI combines advanced AI technology with legal expertise to streamline your workflow. Research case law, draft petitions and contracts, and get instant insights from legal documents.",
    part3:
      "Our AI-powered platform makes legal research faster and more efficient. Upload your documents, ask questions, and get intelligent responses backed by your legal knowledge base.",
    githubIssue: "Get Support",
    user1: "How do I get started?",
    part4:
      "It's simple. All your documents are organized into \"Workspaces\". Workspaces contain your legal documents, case files, judgments, and research materials. The AI uses these documents to provide accurate, contextual responses.\n\nYou can add and remove documents at anytime to keep your workspace up to date.",
    createWorkspace: "Create your first workspace",
    user2:
      "How does the AI help with my legal work?",
    part5:
      "ParalegalAI offers intelligent legal assistance:\n\n<i>Legal Research:</i> Find relevant judgments, precedents, and case law instantly. The AI searches through your documents and provides citations and summaries.\n\n<i>Smart Drafting:</i> Generate drafts for petitions, contracts, notices, and other legal documents. The AI learns from your existing documents to match your style.\n\n<i>Case Analysis:</i> Get insights on similar cases, identify trends, and understand legal principles from your document collection.",
    user3: "That sounds perfect for my practice!",
    part6: "Start exploring!",
    starOnGitHub: "Learn More",
    contact: "Contact Support",
  },
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "You're on your way to becoming an ParalegalAI expert!",
      dismiss: "close",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of ParalegalAI",
    },
    pfp: {
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for ParalegalAI.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your ParalegalAI instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for ParalegalAI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render ParalegalAI's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
      ...
      "welcome-messages": {
        ...
        user: "user",
        message: "message",
        assistant: "ParalegalAI Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this ParalegalAI instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else ParalegalAI will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall ParalegalAI when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which ParalegalAI can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your ParalegalAI instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your ParalegalAI instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and ParalegalAI handle your data.",
    llm: "LLM Selection",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "These files will be uploaded to the document processor running on this ParalegalAI instance. These files are not sent or shared with a third party.",
    },
    pinning: {
      what_pinning: "What is document pinning?",
      pin_explained_block1:
        "When you <b>pin</b> a document in ParalegalAI we will inject the entire content of the document into your prompt window for your LLM to fully comprehend.",
      pin_explained_block2:
        "This works best with <b>large-context models</b> or small files that are critical to its knowledge-base.",
      pin_explained_block3:
        "If you are not getting the answers you desire from ParalegalAI by default then pinning is a great way to get higher quality answers in a click.",
      accept: "Okay, got it",
    },
    watching: {
      what_watching: "What does watching a document do?",
      watch_explained_block1:
        "When you <b>watch</b> a document in ParalegalAI we will <i>automatically</i> sync your document content from it's original source on regular intervals. This will automatically update the content in every workspace where this file is managed.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "You need to authenticate with the ParalegalAI Community Hub before publishing items.",
