const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "Paralegal AI can work with many LLM providers. This will be the service which handles chatting.",
    },
    userSetup: {
      title: "User Setup",
    ...
    survey: {
      title: "Welcome to Paralegal AI",
      description: "Help us make Paralegal AI built for your needs. Optional.",

      email: "What's your email?",
      useCase: "What will you use Paralegal AI for?",
      useCaseWork: "For work",
      useCasePersonal: "For personal use",
      useCaseOther: "Other",
      comment: "How did you hear about Paralegal AI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Create your first workspace and get started with Paralegal AI.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Welcome to Paralegal AI, Paralegal AI is an open-source AI tool by Mintplex Labs that turns legal documents into a trained chatbot you can query and chat with. Paralegal AI is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
      "Paralegal AI is the easiest way to put powerful AI products like OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB, and other services together in a neat package with no fuss to increase your productivity by 100x.",
    part3:
      "Paralegal AI can run totally locally on your machine with little overhead you wont even notice it's there! No GPU needed. Cloud and on-premises installation is available as well.\nThe AI tooling ecosystem gets more powerful everyday. Paralegal AI makes it easy to use.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "You're on your way to becoming a Paralegal AI expert!",
      dismiss: "close",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "the benefits of Paralegal AI",
    },
    pfp: {
  ...
  customization: {
    interface: {
      ...
      description: "Set your UI preferences for Paralegal AI.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "White-label your Paralegal AI instance with custom branding.",
    },
    chat: {
      title: "Chat",
      description: "Set your chat preferences for Paralegal AI.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Select the preferred language to render Paralegal AI's UI in - when translations are available.",
      },
      logo: {
        title: "Brand Logo",
      ...
      "welcome-messages": {
        ...
        user: "user",
        message: "message",
        assistant: "Paralegal AI Chat Assistant",
  ...
  api: {
    title: "API Keys",
    description:
      "API keys allow the holder to programmatically access and manage this Paralegal AI instance.",
  ...
  llm: {
    title: "LLM Preference",
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. It is important that these keys are current and correct, or else Paralegal AI will not function properly.",
  ...
  transcription: {
    ...
    "warn-start":
      "Using the local whisper model on machines with limited RAM or CPU can stall Paralegal AI when processing media files.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Embedding is the process of turning text into vectors. These credentials are required to turn your files and prompts into a format which Paralegal AI can use to process.",
    provider: {
  ...
  vector: {
    ...
    description:
      "These are the credentials and settings for how your Paralegal AI instance will function. It's important these keys are current and correct.",
    provider: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Protect your Paralegal AI instance with a password. If you forget this there is no recovery method so ensure you save this password.",
  ...
  privacy: {
    ...
    description:
      "This is your configuration for how connected third party providers and Paralegal AI handle your data.",
    llm: "LLM Selection",
