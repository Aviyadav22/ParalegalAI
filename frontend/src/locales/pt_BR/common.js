...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "ParalegalAI funciona com vários provedores de LLM. Este será o serviço que lidará com os chats.",
    },
    userSetup: {
    ...
    survey: {
      title: "Bem-vindo ao ParalegalAI",
      description: "Ajude-nos a melhorar o ParalegalAI. Opcional.",
      email: "Qual seu email?",
      useCase: "Como você usará o ParalegalAI?",
      useCaseWork: "Para trabalho",
      useCasePersonal: "Uso pessoal",
      useCaseOther: "Outro",
      comment: "Como você conheceu o ParalegalAI?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description: "Crie seu primeiro workspace e comece a usar o ParalegalAI.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Bem-vindo ao ParalegalAI, uma ferramenta de IA open-source da ParalegalAI Team que transforma qualquer conteúdo em um chatbot treinado. ParalegalAI é um software BYOK (bring-your-own-keys), sem taxas ou assinaturas.",
    part2:
      "ParalegalAI é a maneira mais fácil de integrar poderosas ferramentas de IA como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB e outros serviços em um pacote simples.",
    part3:
      "ParalegalAI pode rodar localmente na sua máquina com baixo consumo de recursos. Sem GPU necessária. Disponível para instalação na nuvem ou on-premises.\nO ecossistema de IA evolui rapidamente. ParalegalAI facilita seu uso.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed:
        "Você está no caminho para se tornar um expert em ParalegalAI!",
      dismiss: "fechar",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      body: "os benefícios do ParalegalAI",
    },
    pfp: {
  ...
  customization: {
    ...
    branding: {
      ...
      description: "Personalize sua instância do ParalegalAI com sua marca.",
    },
    chat: {
      title: "Chat",
  ...
  transcription: {
    ...
    "warn-start":
      "Usar o modelo local whisper em máquinas com RAM ou CPU limitada pode travar o ParalegalAI.",
  ...
  privacy: {
    ...
    description:
      "Configurações de como provedores terceiros e o ParalegalAI lidam com seus dados.",
    llm: "Seleção de LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Esses arquivos são enviados ao processador local do ParalegalAI. Não são compartilhados com terceiros.",
    },
    pinning: {
